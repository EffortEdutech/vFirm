import type { ActorType, PolicyResult, RiskClass, UUID } from "../../core-domain/src/types.js";
...
export interface PolicyInput {
  ...
  context?: {
    ...
    required_approval_id?: UUID | null;
    approval_subject_version_or_hash?: string | null;
    evidence_bundle_id?: UUID | null;
    professional_authority_valid?: boolean;
    commercial_threshold_exceeded?: boolean;
    missing_required_information?: boolean;

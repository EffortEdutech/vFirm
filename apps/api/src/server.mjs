...
const readCollections = new Map([
  ...
  ["awia-firm-package-assignments", "awia_firm_package_assignments"],
...
async function markAwiaClientDeliveryDraftSent(body, req = null) {
  requireFields(body, ["tenant_id", "firm_id", "client_delivery_draft_id"]);
  const actor = actorFromBody(body, req, body.tenant_id, body.firm_id);
  return markAwiaClientDeliveryDraftSentRecord(body, actor);
}

async function archiveAwiaStaffWorkdeskItem(body, req = null) {
  requireFields(body, ["tenant_id", "firm_id", "workdesk_item_id"]);
  const actor = actorFromBody(body, req, body.tenant_id, body.firm_id);
  return archiveAwiaStaffWorkdeskItemRecord(body, actor);
}
...
async function assignAwiaFirmPackage(body, req = null) {
  requireFields(body, ["tenant_id", "firm_id", "package_code"]);
  const actor = actorFromBody(body, req, body.tenant_id, body.firm_id);
  requireHumanOperationalAuthority(actor, "assignAwiaFirmPackage");
...
async function hireAwiaFirmWorker(body, req = null) {
  requireFields(body, ["tenant_id", "firm_id", "role_code"]);
  const actor = actorFromBody(body, req, body.tenant_id, body.firm_id);
  return hireAwiaFirmWorkerRecord(body, actor);
}

...
// Static file server + /api proxy for the new Owner/Admin console.
// Deliberately modeled on apps/web/src/server.mjs -- same pattern, new
// port, new publicDir. Does not touch or import anything from apps/web.
...
server.listen(port, () => console.log(`vFirm Web Console listening on http://127.0.0.1:${port} (API: ${apiBase})`));

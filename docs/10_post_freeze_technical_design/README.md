...
| `PD_H5_CONTROLLED_PRIVATE_DIRECTORY_PILOT_CLOSEOUT_REVIEW_v1.0.md` | Defines controlled private directory pilot closeout evidence, issue classification, decision options, and next scope decision path. |
| `PD_H6_PRIVATE_DIRECTORY_PILOT_LEARNING_BACKLOG_AND_NEXT_SCOPE_DECISION_v1.0.md` | Classifies pilot learning backlog items and prepares product-owner next-scope decision options without default marketplace widening. |
| Document | Purpose |
|---|---|
...
| `UI_CORPORATE_WORKSPACE_SHELL_POLISH_RESULT_v1.0.md` | Completion evidence for corporate workspace shell polish, hamburger sidebar navigation, structured active workspace context, and development-mode full feature visibility. |
...
| `OP_H3_FORMWORK_PILOT_DAY_REHEARSAL_COMPLETION_v1.0.md` | Completion evidence for controlled Formwork pilot-day rehearsal, technical issue block, human professional approval, audit reconstruction, and firm-scoped export. |
| `OP_H4_NHL_GLOBAL_SOLUTION_PILOT_DAY_REHEARSAL_COMPLETION_v1.0.md` | Completion evidence for controlled NHL Global Solution organization-support pilot-day rehearsal, human review before client-facing output, invoice/receivable monitoring without live payment movement, audit reconstruction, and firm-scoped export. |
| `OP_H5_PILOT_EVIDENCE_AUDIT_EXPORT_CLOSEOUT_REVIEW_v1.0.md` | Completion evidence for multi-firm pilot evidence pack template, closeout review template, audit reconstruction checklist, legally permissible export checklist, unresolved finding classification, and privacy/redaction notes. |

...
| `NHL_GLOBAL_SOLUTIONS_ONBOARDING_REHEARSAL_RESULT_v1.0.md` | Controlled local onboarding rehearsal evidence for NHL Global Solutions, owned by Nur Hernieliana, covering virtual services, six AI workers, day-to-day workflow, approvals, receivables, auditability, export, and negative controls. |
